...
static int IRAM_ATTR vfs_spiffs_fstat(int fd, struct stat * st) {
    ...
    st->st_blksize = 256;        //CONFIG_SPIFFS_LOG_PAGE_SIZE;
...
int spiffs_mount() {
    ...
    cfg.phys_addr 		 = 0x180000;     //CONFIG_SPIFFS_BASE_ADDR;
    cfg.phys_size 		 = 1048576;  //CONFIG_SPIFFS_SIZE;
    cfg.phys_erase_block = SPIFFS_ERASE_SIZE;
    cfg.log_page_size    = 256;         //CONFIG_SPIFFS_LOG_PAGE_SIZE;
    cfg.log_block_size   = 8192;        //CONFIG_SPIFFS_LOG_BLOCK_SIZE;
